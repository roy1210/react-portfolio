...
import SkillsProgressBuffer from "../ResumeProgress/SkillsProgressBuffer";
import SkillsProgress from "../ResumeProgress/SkillsProgress.js";
import ResumeOtherSkills from "./ResumeOtherSkills";
...
const ResumeSkills = () => (
  <div className="Resume-skills">
    ...
    <SkillsProgress skill="TypeScript" blank={6} progress={30} />
    ...
    <p>
      ...
      MongoDB, SSR with Next.js and fetch API endpoint from Django
    </p>
    ...
    <SkillsProgressBuffer skill="Python" blank={11} progress={40} />
    <p>
      Basic syntax for Flake8, Unit testing, SQLAlcemy, Nampy, Pandas, Logging,
      and Django
    </p>
    <SkillsProgressBuffer skill="Django" blank={11} progress={20} />
    <p>
      Develop CRUD Web apps with Django REST framework and serving with React.js
    </p>
